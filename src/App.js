...
var mon = [
  ...
  ['йогурт грецький "extra 2%"', 150, 6.7, 2, 4.9, 64],
...
var tue = [
  ...
  ['яйця (4 білки, 2 жовтки)', 200, 12, 10, 0.8, 140],
...
var wed = [
  ...
  ['тунець шматочками "Премія"', 130, 25.57, 0.56, 0, 140],
  ...
  render() {
    return (
      <Importer>
        {transactions =>
          <div className="App">
            <DailyNutritionPlan foods={mon} />
            <DailyNutritionPlan foods={tue} />
            <DailyNutritionPlan foods={wed} />
            <DailyNutritionPlan foods={thu} />
            <DailyNutritionPlan foods={fri} />
            <DailyNutritionPlan foods={sat} />
            <DailyNutritionPlan foods={sun} />
            <WeeklyNutritionPlan foods={[mon, tue, wed, thu, fri, sat, sun]} />
